...
export class SendBautagebuchroutsClass {
  ...
  public  sendbautagebuchrouter: any;
  ...
  Init(config: ConfigClass) {
    ...
    try {
      ...
      this.Debug.ShowErrorMessage(error, 'SendBautagebuchroutsClass', 'Init', this.Debug.Typen.Class);
    }
  }
  ...
  public SetRoutes() {
    ...
    try {
      ...
      this.sendbautagebuchrouter.put('/', async (req: Request, res: Response) => {


        filebuffer = [];

        console.log('Send Bautagebuch');
        ...
        try {
          ...
          console.error('Bautagebuch senden fehlgeschlagen. Datei exisiert nicht.: ' + error.message);
        ...
        if(getdata) {
          ...
          getdata.on('end', () => {
            ...
            graphClient.api(emailurl).post(sendMail).then((result) => {
              ...
              console.error('Bautagebuch senden fehlgeschlagen. Sendevorgang fehlerhaft: ' + mailerror.message);
      ...
      this.Debug.ShowErrorMessage(error.message, error,  'SendBautagebuchroutsClass', 'SetRoutes');
    }
  }
}
